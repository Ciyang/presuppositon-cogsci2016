...
\multicolumn{3}{c}{$L_0(Q(w) \mid u, Q) \propto  \sum_{w'\in C\cap \intp{u}} \delta_{Q(w)=Q(w')} \cdot \Pr(w')$} \\
...
\vspace{-6pt}
\begin{equation}
L_0(Q(w) \mid u, Q) \propto  \sum_{w'\in C\cap \intp{u}} \delta_{Q(w)=Q(w')} \cdot \Pr(w') \label{eq:literal-CG}
\end{equation}

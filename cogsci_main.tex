...
It further predicts an interaction between projective behavior and the  
 \emph{question under discussion} (QUD) \cite{Roberts2012:Information-Structure}, adding a new direction for further experimental research to the growing body of literature
